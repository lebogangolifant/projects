...
try:
    ...
    print("tkinter did not import successfully - check you are running Python 3 and that
...
class Shape():
    ...
    def __init__(self, width=50, height=50, x=None, y=None, color="black"):
        ...
        self.width = width
        self.color = color
https://raw.githubusercontent.com/raspberrypilearning/shapes/master/shapes.py 1/4
 15/10/2018 https://raw.githubusercontent.com/raspberrypilearning/shapes/master/shapes.py
...
self.y = y
    ...
    def randomize(self, smallest=20, largest=200):
        """Randomly generates width, height, position and colour for a shape. You can
specify
        ...
        self.color = random.choice(["red", "yellow", "blue", "green", "gray", "white",
"black", "cyan", "pink", "purple"])
...
self.y = y
    def set_color(self, color):
        ...
        self.color = color
    def get_color(self):
https://raw.githubusercontent.com/raspberrypilearning/shapes/master/shapes.py 2/4
...
https://raw.githubusercontent.com/raspberrypilearning/shapes/master/shapes.py 3/4
